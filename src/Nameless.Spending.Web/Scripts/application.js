...
(function () {
     ...
     * ================
     * Main JS application file for Application. This file should be included in
     * all pages. It controls some layout options and implements exclusive
     * Application plugins.
     */
     ...
     *
     * @type Object
     * @description $.Application is the main object for the app. It's used for
     *              implementing functions and options related to the template.
     *              Keeping everything wrapped in an object prevents conflict
     *              with other plugins and is a better way to organize our code.
     */
    $.Application = {};
    ...
    $.Application.options = {
        ...
        controlSidebarOptions: {
            ...
            toggleButtonSelector: '[data-toggle="control-sidebar"]',
        ...
        // The standard screen sizes that bootstrap uses. If you change these in
        // the variables.less file, change them here too.
        screenSizes: {
            xsmall: 480,
            small: 768,
            medium: 992,
    ...
    $(function () {
        ...
        $('.btn-group[data-toggle="btn-toggle"]').each(function () {
            ...
            $(this).find('.btn').on('click', function (e) {
                self.find('.btn.active').removeClass('active');
    ...
    function initialize() {
        ...
        $.Application.pushMenu = {
            activate: function (toggleBtn) {
                ...
                $(toggleBtn).on('click', function (e) {
                    ...
                    if ($(window).width() > (screenSizes.small - 1)) {
                ...
                $('.content-wrapper').click(function () {
                    ...
                    if ($(window).width() <= (screenSizes.small - 1) && $('body').hasClass('sidebar-open')) {
            ...
            expandOnHover: function () {
                var self = this;
                var screenWidth = $.Application.options.screenSizes.small - 1;
        ...
        $.Application.controlSidebar = {
            ...
            activate: function () {
                ...
                // The toggle button
                var btn = $(options.toggleButtonSelector);
            ...
            open: function (sidebar, slide) {
                ...
                if (slide) {
                    ...
                    // Push the content by adding the open class to the body instead of the sidebar
                    // itself
        ...
        $.Application.boxWidget = {
            ...
            collapse: function (element) {
                ...
                if (!box.hasClass('collapsed-box')) {
                    ...
                    // Hide the content
                    boxContent.slideUp(self.animationSpeed, function () {
                    ...
                    // Show the content
                    boxContent.slideDown(self.animationSpeed, function () {
     ...
     * activate a box inserted in the DOM after the application.js was
     * loaded.
     *
     * @type plugin
